...
const metadata = {
    ...
    description: "Formando jovens discípulos e líderes para transformar o mundo através do amor de Cristo. Organização Embaixadores do Rei - Embaixada Billy Graham.",
    manifest: "/icones/site.webmanifest",
    icons: {
        icon: [
            {
                url: "/icones/favicon-32x32.png",
                sizes: "32x32",
                type: "image/png"
            },
            {
                url: "/icones/favicon-16x16.png",
                sizes: "16x16",
                type: "image/png"
            },
            {
        ...
        apple: [
            {
                url: "/icones/apple-touch-icon.png",
                sizes: "180x180"
            }
        ]
    }
